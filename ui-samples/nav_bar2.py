...
# - Middle output area with working scrollbar (PageUp/PageDown)
...
def make_app() -> Application:
    ...
    output = TextArea(
        ...
        scrollbar=True,
        focusable=True,  # <-- make it focusable so we can move its cursor
        wrap_lines=True,
        read_only=True,
    )
    ...
    @kb.add("pageup")
    def _(event) -> None:
        # Move cursor up in the output buffer; viewport follows
